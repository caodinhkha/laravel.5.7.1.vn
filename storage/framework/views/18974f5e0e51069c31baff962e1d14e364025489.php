            ...
            <div class="container bg-payment">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-6 bg-one">
                        ...
                        <div class="content">
                            Quý khách có thể thanh toán tiền mặt trực tiếp khi mua hàng tại cửa hàng, chuyển khoản, hoặc thanh toán cho nhân viên chuyển phát đối với hình thức chuyển phát COD.
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-6 bg-two">
                        <h1 class="two"><a href="">Giao hàng toàn quốc</a></h1>
                        <div class="content">
                            Thời Trang Sài Gòn hỗ trợ phương thức giao hàng và thu tiền tận nơi trên toàn quốc.
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-6 bg-three">
                        <h1 class="three"><a href="">Đổi trả trong vòng 7 ngày</a></h1>
                        <div class="content">Đổi trả sản phẩm nếu bạn không hài lòng. Điều kiện về thời gian đổi trả: trong vòng 7 ngày kể từ khi nhận được hàng.</div>
                    </div>
                </div>
                <!-- /row -->
            </div>
                ...
                <div class="row footer-content">
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="short_about_us">
                            <p>Thời Trang Sài Gòn thiên đường mua sắm của bạn</p>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="http://cherrykids.vn/index.php?route=information/contact">Trang chủ</a></li>
                            <li><a href="http://cherrykids.vn/gioi-thieu">Giới thiệu</a></li>
                            <li><a href="http://cherrykids.vn/thong-tin-giao-hang">Thời trang nam</a></li>
                            <li><a href="http://cherrykids.vn/chinh-sach-bao-mat">Thời trang nữ</a></li>
                            <li><a href="http://cherrykids.vn/dieu-khoan">Khuyến mãi</a></li>
                            <li><a href="http://cherrykids.vn/dieu-khoan">Hướng dẫn</a></li>
                            <li><a href="http://cherrykids.vn/dieu-khoan">Tin tức</a></li>
                            <li><a href="http://cherrykids.vn/dieu-khoan">Liên hệ</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12">
