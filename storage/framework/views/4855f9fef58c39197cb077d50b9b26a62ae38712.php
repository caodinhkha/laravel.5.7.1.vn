...
<head>
    ...
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?php echo e(asset("/static/library/AdminLTE-2.4.5/bower_components/Ionicons/css/ionicons.min.css")); ?>">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo e(asset("/static/library/AdminLTE-2.4.5/dist/css/AdminLTE.min.css")); ?>">
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo e(asset("/static/library/AdminLTE-2.4.5/plugins/iCheck/square/blue.css")); ?>">
...
<!-- iCheck -->
<script src="<?php echo e(asset("/static/library/AdminLTE-2.4.5/plugins/iCheck/icheck.min.js")); ?>"></script>
<script>
  $(function () {
    $('input').iCheck({
